...
<html lang="en">
    <head>
        ...
        <title>Control Panel| Users Files</title>
        <!-- Favicon-->
    ...
    <body id="page-top">
            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="files.php">Files &nbsp;<i class="bi bi-bag-heart"></i></a></li>
      ...
      <br><br><br>
        ...
        <section class="page-section bg-light">
              <a href="newuser.php"  class="btn btn-info">
         <i class="bi bi-plus-square-fill"></i> &nbsp;  Add New User 
        </a> <br><br>
 <table class="table">
  <thead>
  ...
  <tbody>
    ...
    <tr align="center">
      <td><?php 
          $un="select * from users where email='$e'";
          $rn=mysqli_query($co,$un);
          while($row=mysqli_fetch_array($rn)){
              echo $row['name'];
          }
          ?></td>
      <td><?php echo $e;?></td>
      <td><img src="../img/<?php echo $r;?>" width="60" ></td>
      <td><?php echo $d; ?></td>
      <td>
          <form action="" method="POST">
          <a href="files.php?del=<?php echo $id;?>" onclick="return confirm('Delete User?');" class="btn btn-danger"><i class="bi bi-trash"></i></a>
          </form>
      </td>
    </tr>
      <?php } ?>
