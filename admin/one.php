            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="one.php">Home &nbsp;<i class="bi bi-house"></i></a></li>
                    </ul>
                </div>
            </div>
        </nav>
            ...
            <div class="container px-4 px-lg-5">
                <div class="row gx-4 gx-lg-5 justify-content-center">
                    <div class="col-lg-8 text-center">
                        ...
                        <p class="text-black-75 mb-4">You can manage users and administrators and see the photos uploaded by users, you can also manage your account using the top menu.</p>
                        <a class="btn btn-info btn-xl text-white" href="profile.php">View Profile</a>
                    </div>
                </div>
            </div>
        </section>