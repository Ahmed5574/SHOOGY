            ...
            <div class="container px-4 px-lg-5">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0">
                        ...
                        <li class="nav-item"><a class="nav-link active" href="users.php">Users &nbsp;<i class="bi bi-capsule-pill"></i></a></li>
 ...
 <table class="table">
  ...
  <tbody>
    ...
    <tr align="center">
      ...
      <td><input type="password" value="<?php echo $pp;?>"></td>
      <td>
          <form action="" method="POST">
          <a href="users.php?del=<?php echo $row['id'];?>" onclick="return confirm('Delete User?');" class="btn btn-danger"><i class="bi bi-trash"></i></a>
          </form>
      </td>
    </tr>
      <?php } ?>
